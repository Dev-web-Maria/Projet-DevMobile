...
const ClientTabNavigator = ({ route }) => {
  // Récupérer les paramètres passés
  const { user } = route.params || {};

  console.log("User in ClientTabNavigator:", user);
  ...
  return (
    ...
    >
      <Tab.Screen
        name="Allocation"
        children={(props) => <AllocationScreen user={user} {...props} />}
      />

      <Tab.Screen
        name="Dashboard"
        children={(props) => <ClientDashboard user={user} {...props} />}
      />

      <Tab.Screen
        name="Historique"
        children={(props) => <ClientHistoryScreen user={user} {...props} />}
      />
      <Tab.Screen
        name="Profil"
        children={(props) => <ClientProfile user={user} {...props} />}
      />
    </Tab.Navigator>
  );
};
